...
function Card({username, btnText="Get connect"}){//we can also add default values of props here

    // console.log("props",props); //props is an object
    // console.log(props.username);
    //we can directly call username
    ...
    <div className="p-4 border-t mx-8 mt-2">
        <button className="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">{btnText || "follow me"}</button>
        {/* if some properties are missing then, it will print default values */}
    </div>
</div>
    )
}
